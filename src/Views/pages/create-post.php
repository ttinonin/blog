...
<form action="/php/blog/post" method="POST">
    ...
    <button type="submit" class="py-2 w-full bg-green-500 text-white font-medium text-sm rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2">Post</button>
</form>
